...
#define PFU_PASS_BUBBLE_CYCLES 48
#define PFU_TABLE_PATH_CYCLES 49
#define PFU_FAST_PATH_CYCLES 50
#define PFU_COMMIT_CYCLES 51
...
#define PFU_COEFF_RELOADS (INCREMENTAL_COUNTERS + 11)
#define PFU_CANCEL_LO (INCREMENTAL_COUNTERS + 12)
#define PFU_CANCEL_HI (INCREMENTAL_COUNTERS + 13)
#define PFU_TABLE_WRITES (INCREMENTAL_COUNTERS + 14)
#define PFU_CONFIG_ERRORS (INCREMENTAL_COUNTERS + 15)
#define PFU_STAT_OVERFLOW (INCREMENTAL_COUNTERS + 16)
